document.addEventListener("DOMContentLoaded", function () {
  ...
  if (isMobileDevice()) {
    document.getElementById("projects").innerHTML = `
        <div class="container grid grid-cols-12 gap-8">
            <div class="col-span-12 md:col-span-6">
                <!-- Project card -->
                <a href="https://github.com/AccessRetrieved/RoombaRat" class="block relative mb-16">
                    <img class="relative -z-10" src="assets/img/roombarat.jpg" alt="">
                    <div class="bg-white w-10/12 pt-4 pr-4 -mt-28">
                        <h3 class="text-lg lg:text-xl font-medium">RoombaRat (2026)</h3>
                        <p>CascadiaJS Hackathon 2026, CascadiaJS Seattle</p>
                    </div>
                </a>
                <!-- Project card -->
                ...
                <!-- Project card -->
                <a href="https://github.com/AccessRetrieved/bdc2024-youth-abuse-ml" class="block relative mb-16">
                    <img class="relative -z-10" src="assets/img/bdc.png" alt="">
                    <div class="bg-white w-10/12 pt-4 pr-4 -mt-28">
                        <h3 class="text-lg lg:text-xl font-medium">Big Data Challenge (2024)</h3>
                        <p>Publication: Identifying Factors Influencing Youth Substance Abuse in Canada: Insights from Machine Learning Models.</p>
                    </div>
                </a>
                <!-- Project card -->
    ...
    <div class="col-span-12 md:col-span-6">
        ...
        <!-- Project card -->
        <a href="https://github.com/AccessRetrieved/codegpt" class="block relative mb-16" style="margin-top: 2.5rem;">
            <img class="relative -z-10" src="assets/img/CodeGPT.jpeg" alt="">
            <div class="bg-white w-10/12 pt-4 pr-4 -mt-28">
                <h3 class="text-lg lg:text-xl font-medium">CodeGPT (2025)</h3>
                <p><i>Winner of Best overall hack, 2025</i></p>
        ...
        <!-- Project card -->
        <a href="https://constellationhub.org" class="block relative mb-16" style="margin-top: -1.5rem;">
            <img class="relative -z-10" src="assets/img/constellation.jpg" alt="">
            <div class="bg-white w-10/12 pt-4 pr-4 -mt-28">
                <h3 class="text-lg lg:text-xl font-medium">Constellation Networking (2023 - Present)</h3>
            </div>
        ...
        <!-- Project card -->
        <a href="" class="block relative" style="margin-top: 3rem;">
            <img class="relative -z-10" src="assets/img/postman.jpg" alt="">
            <div class="bg-white w-10/12 pt-4 pr-4 -mt-28">
                <h3 class="text-lg lg:text-xl font-medium">App Postman (2021)</h3>
            </div>
    ...
    <div class="col-span-12 md:col-span-6">
        <!-- Project card -->
        <a href="https://github.com/AccessRetrieved/medlinks" class="block relative mb-16 mt-40 mobile-no-mt">
            <img class="relative -z-10" src="assets/img/medlinks.jpeg" alt="">
            <div class="bg-white w-10/12 pt-4 pr-4 -mt-28">
                <h3 class="text-lg lg:text-xl font-medium">Medlinks (2025)</h3>
                <p>nwHacks, nwPlus + Major Leagues Hacking</p>
        ...
        <!-- Project card -->
        <a href="https://github.com/AccessRetrieved/bdc2024-youth-abuse-ml" class="block relative mb-16" style="margin-top: -2rem;">
            <img class="relative -z-10" src="assets/img/bdc.png" alt="">
            <div class="bg-white w-10/12 pt-4 pr-4 -mt-28">
                <h3 class="text-lg lg:text-xl font-medium">Big Data Challenge (2024)</h3>
                <p>Publication: Identifying Factors Influencing Youth Substance Abuse in Canada: Insights from Machine Learning Models.</p>
        ...
        <!-- Project card -->
        <a href="https://gptnotes.iamjerryhu.org" class="block relative mb-16" style="margin-top: 1.5rem;">
            <img class="relative -z-10" src="assets/img/gptnotes.jpg" alt="">
            <div class="bg-white w-10/12 pt-4 pr-4 -mt-28">
                <h3 class="text-lg lg:text-xl font-medium">GPTNotes (2022 - 2023)</h3>
            </div>
        ...
        <!-- Project card -->
        <a href="https://accessretrieved.github.io/Music/" class="block relative mb-16" style="margin-top: -2.5rem;">
            <img class="relative -z-10" src="assets/img/oh-my-music.jpg" alt="">
            <div class="bg-white w-10/12 pt-4 pr-4 -mt-28">
                <h3 class="text-lg lg:text-xl font-medium">Oh My Music (2020)</h3>
            </div>
